...
/**
 * Positions politiques manuelles pour les groupes européens (PE)
 *
 * ParlGov ne couvre pas les groupes européens directement (seulement les partis nationaux).
 * Ces positions sont basées sur Chapel Hill Expert Survey et VoteWatch Europe.
 *
 * Échelle 0-10 : 0 = extrême gauche, 10 = extrême droite
 */
export const EU_GROUP_POSITIONS: Record<string, number> = {
	// Extrême gauche
	'GUE/NGL': 1.5,
	'The Left': 1.5,
	...
	// Centre-droit
	PPE: 6.5, // European People's Party
	'PPE-DE': 6.5, // Ancien nom

	// Droite
	ECR: 7.5, // European Conservatives and Reformists

	// Extrême droite
	ID: 8.5, // Identity and Democracy
	ENF: 8.5, // Europe of Nations and Freedom (prédécesseur ID)
	EFD: 8.0, // Europe of Freedom and Democracy
	ITS: 8.5, // Identity, Tradition, Sovereignty
	'Patriots for Europe Group': 8.5,
	'Europe of Sovereign Nations Group': 9.0
};

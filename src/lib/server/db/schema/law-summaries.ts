...
/**
 * Table pour stocker les résumés et tags générés par LLM pour les lois.
 ...
 */
export const lawSummaries = pgTable(
	'law_summaries',
	{
		...
		// Tags de catégorisation (ex: ["économie", "environnement"])
	...
	(table) => [index('law_summaries_tags_idx').using('gin', table.tags)]
);

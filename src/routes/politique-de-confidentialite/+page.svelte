<svelte:head>
	<title>Politique de confidentialité - NosElus</title>
</svelte:head>
...
<div class="legal-content">
	...
	<section class="legal-section">
		<h2>Données collectées auprès des visiteurs</h2>
		<p>
			NosElus ne collecte <strong>aucune donnée personnelle</strong> de ses visiteurs.
		</p>
		<ul>
			<li>Pas de création de compte ni d'inscription</li>
			<li>Pas de formulaire de contact sur le site</li>
			<li>Pas de traceur publicitaire ni d'outil d'analyse d'audience</li>
			<li>Pas de partage de données avec des tiers</li>
		</ul>
	</section>
	...
	<section class="legal-section">
		...
		<table>
			...
			<tbody>
				<tr>
					<td><code>noselus-period-an</code></td>
					<td>Législature sélectionnée pour l'Assemblée nationale</td>
					<td>1 an</td>
				</tr>
				<tr>
					<td><code>noselus-period-senat</code></td>
					<td>Renouvellement sélectionné pour le Sénat</td>
					<td>1 an</td>
				</tr>
				<tr>
					<td><code>noselus-period-pe</code></td>
					<td>Terme sélectionné pour le Parlement européen</td>
					<td>1 an</td>
				</tr>
			</tbody>
		</table>
	...
	<section class="legal-section">
		...
		<h3>Base légale</h3>
		<p>Ce traitement repose sur les fondements suivants :</p>
		<ul>
			<li>
	...
	<section class="legal-section">
		...
		<p>
			Conformément au RGPD, les personnes dont les données sont traitées disposent des droits
			suivants :
		</p>
		<ul>
			<li>
	...
	<section class="legal-section">
		...
		<ul>
			...
			<li>Protection contre le MIME sniffing (X-Content-Type-Options)</li>
			<li>Politique de referrer restrictive (Referrer-Policy)</li>
			<li>Cookies fonctionnels avec attribut <code>SameSite=Lax</code></li>
		</ul>
	</section>

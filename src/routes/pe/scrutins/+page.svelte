...
<svelte:head>
	<title>Scrutins - Parlement européen - NosElus</title>
</svelte:head>

<div class="page-header">
	<h1 class="page-title">Scrutins européens</h1>
	<p class="page-subtitle">{data.pagination.total} scrutins en session plénière</p>
</div>
...
{:else}
	<div style="display: flex; flex-direction: column; gap: 1rem;">
		{#each data.scrutins as scrutin}
			...
			<a href="/pe/scrutins/{scrutin.id}" class="scrutin-card" class:adopted={scrutin.result === 'adopté'} class:rejected={scrutin.result === 'rejeté'}>
